...
impl PublicStruct {
    ...
    pub fn method_with_mut_boxed_self_ref(self: Box<Self>) {}

    pub fn method_with_boxed_self_ref_that_becomes_pinned(self: Pin<Box<Self>>) {}

    pub fn method_with_self_ref_that_becomes_mut_ref(&mut self) {}
}
